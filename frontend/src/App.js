...
const screenViews = {
  ...
  SetupPairingComputer: () => <div>
    ...
    <p>If you have a barcode reader on your phone, you can use scan this: <img src={"https://zxing.org/w/chart?cht=qr&chs=350x350&chld=L&choe=UTF-8&chl=" + encodeURIComponent("http://megacomplete.net/?" + clientId + "-c")} /></p>
  </div>,
