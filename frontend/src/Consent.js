    ...
    return (
      ...
      >
        ...
        <p>
          ...
          <b>
            You will need a smartphone with WiFi to complete this task.
          </b>{" "}
          Participants must be adults (at least 18 years old).{" "}
          <strong>
            If you have previously completed this study, please don't do it
            again. If you realize partway through, that's ok, finish it and
            leave a note.
          </strong>
        </p>
        <p>
          Your phone will need to have a good connection with our server for
          this task.
        </p>
        ...
        <p>
          It is your choice whether or not to participate in this
          research.&nbsp; If you choose to participate, you may change your mind
          and leave the study at any time.&nbsp; Refusal to participate or
          stopping your participation will involve no penalty or loss of
          benefits to which you are otherwise entitled. Participants must be
          adults 18+.
        </p>
        <p>
          <b>
        ...
        <p>
          <b>
            <span style={{ fontSize: "14.0pt" }}>
              What can I expect if I take part in this research? What is the
              time commitment?
            </span>
          </b>
        </p>
        <p>
          You will type a few paragraphs of text, using keyboards that give
          various kinds of help in the process. You should not include any
        ...
        <p>
          ...
          smartphone. Please take a break if you start to feel any discomfort
        ...
        <p>
          ...
          in this research. The results of this research may inform future
          advances in computer systems that assist writing.
        </p>
        <p>
          <b>
            <span style={{ fontSize: "14.0pt" }}>
        ...
        <p>
          We will not record any personally identifying information.
        ...
        <p>
          ...
          experiment concludes. But if the security of the MTurk platform or our
        ...
        <p>
          <b>
            <span style={{ fontSize: "14.0pt" }}>
              If I have any questions, concerns or complaints about this
              research study, who can I talk to?
            </span>
          </b>
        </p>
        <p>
        ...
        <ul style={{ marginTop: "0in" }} type="disc">
          <li>
            If your questions, concerns, or complaints are not being answered by
            the research team,
          </li>
