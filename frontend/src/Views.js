...
export const ReadyPhone = inject('state')(observer(({state}) => state.passedQuiz ? <div>
    ...
    <p>The keyboard may show words or phrases. They may or may not be useful to you
     to <b>save typing</b> or to <b>give ideas</b>. The way the keyboard picks words or phrases to show
     will be <b>different for each restaurant</b>, but try to <b>pay the same amount of attention</b> to them for each restaurant.</p>
